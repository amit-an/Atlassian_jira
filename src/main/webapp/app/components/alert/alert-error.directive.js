(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('hipsterGitlabCiSampleMavenApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-hipsterGitlabCiSampleMavenApp-error');
                var entityKey = httpResponse.headers('X-hipsterGitlabCiSampleMavenApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('hipsterGitlabCiSampleMavenApp.' + fieldError.objectName + '.' + convertedField);
